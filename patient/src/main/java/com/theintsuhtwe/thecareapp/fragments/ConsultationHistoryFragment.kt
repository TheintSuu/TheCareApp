 ...
 * Use the [ConsultationHistoryFragment.newInstance] factory method to
...
class ConsultationHistoryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ConsultationHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ConsultationHistoryFragment().apply {
