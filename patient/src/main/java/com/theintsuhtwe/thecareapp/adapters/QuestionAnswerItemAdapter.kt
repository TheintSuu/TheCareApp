...
class QuestionAnswerItemAdapter  (private val mDelegate: SpecialitiesItemDelegate) : BaseAdapter<BaseViewHolder<QuestionVO>, QuestionVO>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<QuestionVO> {
        ...
        return  AnswerViewHolder(mDelegate,v)
    }
