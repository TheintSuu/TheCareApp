...
//        when(msgType){
//            NOTI_TYPE_SEND_BROADCASET_REQUEST -> {
//                val detailIntent = RequsetDetailsActivity.newIntentNoti(
//                        this, orderID.toInt(),
//                        isRefill = false,
//                        needToReLaunch = true
//                )
//                PendingIntent.getActivity(this, 1, detailIntent, PendingIntent.FLAG_UPDATE_CURRENT)
//            }
//
//    }
